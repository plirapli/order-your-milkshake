...
export default function Juice({name, size, flavor}) {
  return (
    <div className="h-84 overflow-hidden relative flex flex-col justify-end items-center">
      ...
      <div className="absolute w-full h-12 bg-black bg-opacity-10 rounded-full-50 transform"></div>
    </div>
  )
}
